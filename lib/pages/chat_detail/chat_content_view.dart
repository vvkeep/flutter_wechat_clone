...
import '../../constants.dart' show AppColors, MessageDetailSelects;
...
class ChatContentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _showMenu(BuildContext context, Offset tapPos) {
      ...
      //通过使用context.findRenderObject来获取我们的widget所在的渲染对象RenderBox，
      //渲染对象里包含位置position、大小size、和一些其他关于渲染的信息，
      //有了这些信息能够帮助我们计算在哪里展示我们的悬浮列表。
